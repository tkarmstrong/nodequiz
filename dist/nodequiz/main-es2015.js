...
module.exports = "<div class=\"container\">\n\n  <div fxLayout=\"row wrap\" fxLayoutGap=\"32px\" fxLayoutAlign=\"center center\">\n\n    <ng-container *ngFor=\"let card of cards\">\n      <p-card header=\"{{ card.cardHeader }}\" subheader=\"{{ card.cardSubheader }}\" [style]=\"{width: '360px'}\" styleClass=\"ui-card-shadow\">\n        <p-header>\n          <img src=\"{{ card.cardImage }}\">\n        </p-header>\n          <div>{{ card.cardContent }}\n        </div>\n        <p-footer>\n          <button\n            (click)=\"startPresentation($event, card)\"\n            class=\"btn-primary\"\n            pButton type=\"button\"\n            label=\"{{ card.btnText }}\"\n          ></button>\n        </p-footer>\n      </p-card>\n\n    </ng-container>\n  </div>\n</div>\n"
...
module.exports = "<div *ngIf=\"presentation\" class=\"container\">\n\n  <mat-card>\n    <mat-card-title>{{presentation.title}}</mat-card-title>\n    <mat-card-content>\n      <p-carousel headerText=\"{{presentation.subTitle}}\" [value]=\"images\" numVisible=\"1\">\n        <ng-template style=\"text-align: center;\" let-image pTemplate=\"image\">\n          <div fxLayout=\"column\" fxLayoutAlign=\"center center\">\n            <div fxFlex>\n              <img fxFlexFill src=\"{{image.source}}\">\n            </div>\n          </div>\n        </ng-template>\n      </p-carousel>\n    </mat-card-content>\n    <mat-card-actions>\n      <button\n        (click)=\"startQuiz($event, quiz)\"\n        type=\"button\"\n        fxFlex\n        mat-stroked-button\n        color=\"warn\"\n      >Take Quiz!</button>\n    </mat-card-actions>\n  </mat-card>\n</div>\n"
...
module.exports = "<div>\n  <!-- Page header -->\n  <header>\n    <!-- Toolbar -->\n    <mat-toolbar class=\"menu\" role=\"header\" color=\"primary\">\n      <mat-toolbar-row>\n        <button mat-button class=\"toolbar__icon-button mat-button\">\n          <mat-icon>menu</mat-icon>\n        </button>\n        <button mat-button class=\"toolbar__icon-button mat-button\">\n          <span style=\"margin-left: 5px !important\" [routerLink]=\"['/']\">NodeQuiz</span>\n        </button>\n\n        <div fxFlex></div>\n\n        <button mat-icon-button class=\"toolbar__icon-button\" [matMenuTriggerFor]=\"menu\">\n          <mat-icon>account_circle</mat-icon>\n        </button>\n        <mat-menu #menu=\"matMenu\">\n          <button mat-menu-item>\n            <mat-icon>perm_contact_calendar</mat-icon>\n            <span>My Profile</span>\n          </button>\n          <button mat-menu-item>\n            <mat-icon>settings</mat-icon>\n            <span>Settings</span>\n          </button>\n          <button mat-menu-item (click)=\"userLogout()\">\n            <mat-icon>exit_to_app</mat-icon>\n            <span>Logout</span>\n          </button>\n        </mat-menu>\n      </mat-toolbar-row>\n    </mat-toolbar>\n  </header>\n\n  <!-- Main page content -->\n  <main>\n    <router-outlet></router-outlet>\n  </main>\n<!-- </div> -->\n"

/***/ }),

/***/ "./node_modules/raw-loader/index.js!./src/app/shared/results-dialog/results-dialog.component.html":
/*!***********************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/shared/results-dialog/results-dialog.component.html ***!
  \***********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "<h1 fxLayoutAlign=\"start center\" mat-dialog-title cdkFocusInitial>{{data.title}}</h1>\n<mat-dialog-content>\n  <h3>{{data.dateTaken}}</h3>\n  <h3 [ngClass]=\"{'incorrect': data.score <= 69, 'correct': data.score >= 70 }\">\n    Your score: {{data.score}}\n  </h3>\n<mat-divider></mat-divider>\n  <div *ngFor=\"let item of data.results; let i=index\">\n    <p>{{i + 1}}. {{item.question}}</p>\n    <p [ngClass]=\"{'incorrect': item.flag==false, 'correct': item.flag==true}\">\n      {{item.answer}}: {{item.flag}}\n    </p>\n  </div>\n</mat-dialog-content>\n\n<mat-dialog-actions align=\"end\">\n  <button color=\"primary\" mat-raised-button mat-dialog-close>Close</button>\n</mat-dialog-actions>\n"
...
/* harmony import */ var _shared_auth_layout_auth_layout_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./shared/auth-layout/auth-layout.component */ "./src/app/shared/auth-layout/auth-layout.component.ts");
...
/* harmony import */ var _pages_presentation_presentation_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./pages/presentation/presentation.component */ "./src/app/pages/presentation/presentation.component.ts");
...
/* harmony import */ var primeng_galleria__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! primeng/galleria */ "./node_modules/primeng/galleria.js");
/* harmony import */ var primeng_galleria__WEBPACK_IMPORTED_MODULE_30___default = /*#__PURE__*/__webpack_require__.n(primeng_galleria__WEBPACK_IMPORTED_MODULE_30__);
/* harmony import */ var primeng_card__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! primeng/card */ "./node_modules/primeng/card.js");
/* harmony import */ var primeng_card__WEBPACK_IMPORTED_MODULE_31___default = /*#__PURE__*/__webpack_require__.n(primeng_card__WEBPACK_IMPORTED_MODULE_31__);
...
/* harmony import */ var _quiz_quiz_component__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./quiz/quiz.component */ "./src/app/quiz/quiz.component.ts");
/* harmony import */ var _shared_results_dialog_results_dialog_component__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ./shared/results-dialog/results-dialog.component */ "./src/app/shared/results-dialog/results-dialog.component.ts");
/*
=====================================
  ; Title: App Module
  ; Author: Tyler Armstrong
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            ...
            _shared_auth_layout_auth_layout_component__WEBPACK_IMPORTED_MODULE_11__["AuthLayoutComponent"],
            ...
            _pages_presentation_presentation_component__WEBPACK_IMPORTED_MODULE_15__["PresentationComponent"],
            _quiz_quiz_component__WEBPACK_IMPORTED_MODULE_34__["QuizComponent"],
            _shared_results_dialog_results_dialog_component__WEBPACK_IMPORTED_MODULE_35__["ResultsDialogComponent"],
        ...
        imports: [
            ...
            primeng_card__WEBPACK_IMPORTED_MODULE_31__["CardModule"],
            primeng_button__WEBPACK_IMPORTED_MODULE_32__["ButtonModule"],
            primeng_carousel__WEBPACK_IMPORTED_MODULE_33__["CarouselModule"],
        ...
        entryComponents: [_shared_results_dialog_results_dialog_component__WEBPACK_IMPORTED_MODULE_35__["ResultsDialogComponent"]]
    })
], AppModule);
...
/* harmony import */ var _shared_guards_auth_guard_auth_guard_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./shared/guards/auth-guard/auth-guard.service */ "./src/app/shared/guards/auth-guard/auth-guard.service.ts");
...
/* harmony import */ var _pages_presentation_presentation_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./pages/presentation/presentation.component */ "./src/app/pages/presentation/presentation.component.ts");
...
/* harmony import */ var _pages_cumulative_summary_cumulative_summary_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./pages/cumulative-summary/cumulative-summary.component */ "./src/app/pages/cumulative-summary/cumulative-summary.component.ts");
/*
=====================================
...
const AppRoutes = [
    { path: '', redirectTo: '/dashboard', pathMatch: 'full' },
    {
        ...
        children: [
            { path: '', component: _pages_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_1__["DashboardComponent"], canActivate: [_shared_guards_auth_guard_auth_guard_service__WEBPACK_IMPORTED_MODULE_2__["AuthGuardService"]] }
        ]
    },
    {
        path: 'session',
        ...
        children: [
            ...
            { path: 'not-found', component: _pages_not_found_not_found_component__WEBPACK_IMPORTED_MODULE_3__["NotFoundComponent"] }
        ]
    },
    {
        path: 'presentations/:id',
        component: _shared_auth_layout_auth_layout_component__WEBPACK_IMPORTED_MODULE_5__["AuthLayoutComponent"],
        children: [{ path: '', component: _pages_presentation_presentation_component__WEBPACK_IMPORTED_MODULE_6__["PresentationComponent"] }]
    },
    {
        path: 'quizzes/:id',
        component: _shared_auth_layout_auth_layout_component__WEBPACK_IMPORTED_MODULE_5__["AuthLayoutComponent"],
        children: [{ path: '', component: _quiz_quiz_component__WEBPACK_IMPORTED_MODULE_7__["QuizComponent"] }]
    },
    {
        path: 'summary',
        component: _shared_auth_layout_auth_layout_component__WEBPACK_IMPORTED_MODULE_5__["AuthLayoutComponent"],
        children: [{ path: '', component: _pages_cumulative_summary_cumulative_summary_component__WEBPACK_IMPORTED_MODULE_8__["CumulativeSummaryComponent"] }]
    },
...
module.exports = "table {\n  width: 100%;\n}\n\nth {\n  font-size: 20px;\n  font-weight: 500;\n}\n\ntd {\n  font-size: 18px;\n}\n\n.pass {\n  color: green;\n}\n\n.fail {\n  color: red;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _shared_services_cumulative_summary_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../shared/services/cumulative-summary.service */ "./src/app/shared/services/cumulative-summary.service.ts");
/*
=====================================
...
let CumulativeSummaryComponent = class CumulativeSummaryComponent {
    constructor(summaryService) {
        ...
        this.displayedColumns = ['user', 'quiz', 'date', 'score'];
    }
    ngOnInit() {
...
CumulativeSummaryComponent.ctorParameters = () => [
    { type: _shared_services_cumulative_summary_service__WEBPACK_IMPORTED_MODULE_2__["CumulativeSummaryService"] }
];
CumulativeSummaryComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        providers: [_shared_services_cumulative_summary_service__WEBPACK_IMPORTED_MODULE_2__["CumulativeSummaryService"]],
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _shared_services_dashboard_card_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../shared/services/dashboard-card.service */ "./src/app/shared/services/dashboard-card.service.ts");
...
let DashboardComponent = class DashboardComponent {
    constructor(dashboardCardService, router) {
...
DashboardComponent.ctorParameters = () => [
    { type: _shared_services_dashboard_card_service__WEBPACK_IMPORTED_MODULE_2__["DashboardCardService"] },
...
DashboardComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        providers: [_shared_services_dashboard_card_service__WEBPACK_IMPORTED_MODULE_2__["DashboardCardService"]],
...
module.exports = ".container {\n  max-width: 320px;\n  margin: 0 auto;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".container {\n  max-width: 500px;\n  margin: 0 auto;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".container {\n  max-width: 40%;\n  margin: 0 auto;\n}\n\n.ui-carousel-page-links {\n  display: none;\n}\n\nbutton {\n  width: 80%;\n}\n\n.mat-card-actions, .mat-card-content, .mat-card-subtitle {\n  margin-bottom: 0px;\n}\n\nbody .ui-carousel .ui-carousel-viewport .ui-carousel-items .ui-carousel-item {\n  border: 0 !important;\n}\n\nbody .ui-carousel .ui-carousel-viewport {\n  border: 0;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _shared_services_presentation_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../shared/services/presentation.service */ "./src/app/shared/services/presentation.service.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/*
=====================================
...
let PresentationComponent = class PresentationComponent {
    constructor(presentationService, router) {
...
PresentationComponent.ctorParameters = () => [
    { type: _shared_services_presentation_service__WEBPACK_IMPORTED_MODULE_2__["PresentationService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
];
PresentationComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        providers: [_shared_services_presentation_service__WEBPACK_IMPORTED_MODULE_2__["PresentationService"]],
...
module.exports = ".container {\n  margin: 0 auto;\n}\n\n.mat-card {\n  margin-top: 20px;\n}\n\n.mat-card-content { margin-left: 50px; }\n\nbutton.submit-quiz-btn {\n  margin: 20px 0;\n  width: 250px;\n}\n\n.back-to-prez-btn {\n  font-size: 12px;\n}\n\n.mat-form-field-invalid .mat-radio-label-content {\n    color:#f44336;\n}\n\n.mat-form-field-invalid .mat-radio-outer-circle {\n    border-color:#f44336!important;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _shared_services_quiz_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../shared/services/quiz.service */ "./src/app/shared/services/quiz.service.ts");
/* harmony import */ var _angular_material__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/material */ "./node_modules/@angular/material/esm2015/material.js");
/* harmony import */ var _shared_results_dialog_results_dialog_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../shared/results-dialog/results-dialog.component */ "./src/app/shared/results-dialog/results-dialog.component.ts");
...
let QuizComponent = class QuizComponent {
    constructor(router, quizService, http, cookie, dialog) {
        this.router = router;
        ...
        this.apiURL = 'http://localhost:3000/api/summary';
        this.summary = {
            userId: '',
            title: '',
    ...
    openResultsDialog() {
        console.log(this.summary);
        const dialogRef = this.dialog.open(_shared_results_dialog_results_dialog_component__WEBPACK_IMPORTED_MODULE_6__["ResultsDialogComponent"], {
            width: '80%',
            height: '350px',
            data: this.summary,
            disableClose: true
...
QuizComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _shared_services_quiz_service__WEBPACK_IMPORTED_MODULE_4__["QuizService"] },
...
QuizComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        providers: [_shared_services_quiz_service__WEBPACK_IMPORTED_MODULE_4__["QuizService"]],
...
module.exports = ".menu {\n  position: fixed;\n  top: 0;\n  left: 0;\n  right: 0;\n  z-index: 2;\n  color: white;\n  background-color: #333333;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".menu {\n  position: fixed;\n  top: 0;\n  left: 0;\n  right: 0;\n  z-index: 2;\n  color: white;\n  background-color: #333333;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/***/ "./src/app/shared/guards/auth-guard/auth-guard.service.ts":
/*!****************************************************************!*\
  !*** ./src/app/shared/guards/auth-guard/auth-guard.service.ts ***!
  \****************************************************************/
...
=====================================
  ...
  ; Author: Tyler Armstrong
  ; Date: 29 Sep 2019
  ; Description: Service for checking
  ;  cookie.
======================================
*/
...
/***/ "./src/app/shared/results-dialog/results-dialog.component.css":
/*!********************************************************************!*\
  !*** ./src/app/shared/results-dialog/results-dialog.component.css ***!
  \********************************************************************/
/*! no static exports found */
...
module.exports = ".incorrect {\n  color: red;\n}\n\n.correct {\n  color: green;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/shared/results-dialog/results-dialog.component.ts":
/*!*******************************************************************!*\
  !*** ./src/app/shared/results-dialog/results-dialog.component.ts ***!
  \*******************************************************************/
...
ResultsDialogComponent.ctorParameters = () => [
    { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] }
];
ResultsDialogComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-results-dialog',
        template: __webpack_require__(/*! raw-loader!./results-dialog.component.html */ "./node_modules/raw-loader/index.js!./src/app/shared/results-dialog/results-dialog.component.html"),
        styles: [__webpack_require__(/*! ./results-dialog.component.css */ "./src/app/shared/results-dialog/results-dialog.component.css")]
    }),
...
/***/ "./src/app/shared/services/cumulative-summary.service.ts":
/*!***************************************************************!*\
  !*** ./src/app/shared/services/cumulative-summary.service.ts ***!
  \***************************************************************/
...
/***/ "./src/app/shared/services/dashboard-card.service.ts":
/*!***********************************************************!*\
  !*** ./src/app/shared/services/dashboard-card.service.ts ***!
  \***********************************************************/
/*! exports provided: DashboardCardService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DashboardCardService", function() { return DashboardCardService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
/*
...
let DashboardCardService = class DashboardCardService {
    constructor(http) {
        this.http = http;
    }
    get() {
...
DashboardCardService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
DashboardCardService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    })
...
/***/ "./src/app/shared/services/presentation.service.ts":
/*!*********************************************************!*\
  !*** ./src/app/shared/services/presentation.service.ts ***!
  \*********************************************************/
...
module.exports = __webpack_require__(/*! /Users/tyler-macbook/Documents/1.School/1.Bellevue/bu-webdev/web-450/nodequiz/src/main.ts */"./src/main.ts");
